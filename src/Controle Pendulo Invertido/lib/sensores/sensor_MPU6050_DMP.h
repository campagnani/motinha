...
#include "include/MPU6050/MPU6050_6Axis_MotionApps20.h"

#if I2CDEV_IMPLEMENTATION == I2CDEV_ARDUINO_WIRE
    #include "Wire.h"
#endif

#define LED_PIN 2 // (Arduino is 13, D1 Mini is 2)
...
bool leuYPR()
{
    if (!dmpReady) return 0;                                           // if programming failed, don't try to do anything
...
void piscaLED()
{
    blinkState = !blinkState;           // Inverte estado do led
    digitalWrite(LED_PIN, blinkState);  // Aplica estado do led
}
